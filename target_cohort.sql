...
FROM (
    ...
    FROM (
        ...
        where concept_id in (321588, 443563)
        UNION
        select c.concept_id
  ...
  FROM (
      ...
      FROM (
          ...
          from (
            ...
            ) C -- End Visit Occurrence Criteria
        ) E
                      ...
                      JOIN (
                        ...
                        SELECT C.person_id,
                          ...
                          COALESCE(
                            ...
                            DATEADD(day, 1, C.condition_start_date)
                          ) as end_date,
                          C.visit_occurrence_id,
...
FROM (
    ...
    from #Inclusion_0) I;
      ...
      with cteIncludedEvents(
        ...
        WHERE (
            MG.inclusion_rule_mask = POWER(cast(2 as bigint), 1) -1
          )
      )
    select event_id,
      person_id,
